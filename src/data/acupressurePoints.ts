...
export const acupressurePoints: AcupressurePoint[] = [
  // ===== PONTOS GRATUITOS - MTC (Medicina Tradicional Chinesa) =====
  {
    ...
    position: { x: 50, y: 25 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/ponto-da-acupuntura-que-tira-ex-hn-yintang-EX-HN3.jpg',
...

  {
    ...
    position: { x: 50, y: 15 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/VG20Baihui.jpg',
...

  {
    ...
    position: { x: 50, y: 90 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/R1-Acalma-a-mente-Vertigem-Tontura-Agitacao.jpg',
...

  {
    ...
    position: { x: 50, y: 30 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/Ponto-basico-A-dor-de-cabeca-e-enxaqueca-copy-copy-copy.jpg',
...

  {
    ...
    position: { x: 20, y: 70 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/C-7-Shenmen-Acalma-a-mente-Estresse.jpg',
...

  {
    ...
    position: { x: 50, y: 75 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/PC8-Laogong-Medo-ansiedade-boca-seca.jpg',
...

  {
    ...
    position: { x: 50, y: 40 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/Voz-rouca-tosse-Ren-22-Tiantu.jpg',
...

  {
    ...
    descriptionFr: 'Point pour soulager rhinite allergique, débloquer voies nasales, réduire sinusite et améliorer respiration nasale. Situé sur le front au milieu des points verticaux, où il y a une flèche. Masser doucement avec mouvements circulaires pendant 2-3 minutes.',
    position: { x: 50, y: 35 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/Ponto-Nariz-Alergia-rinite-sinusite-obstrucao.jpg',
    imageAlt: 'Localização do ponto nasal anti-alérgico na testa no meio dos pontos verticais',
...

  {
    ...
    position: { x: 50, y: 20 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/Pontos-Cerebro-e-cerebelo-Sono-Tonturas-Depressao.jpg',
  ...
  // ===== PONTOS PREMIUM - SEPTICEMIA =====
  {
    ...
    description: 'Ponto para purificar o sangue, combater infecções bacterianas, fortalecer sistema imunológico e reduzir febre. Localizado na dobra externa do cotovelo (veja a marcação em destaque na imagem). Pressionar firmemente por 2-3 minutos, 4x ao dia durante infecções.',
    ...
    position: { x: 25, y: 45 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/IG11-febre-sede-herpes-prurido.jpg',
...

  {
    ...
    description: 'Ponto para fortalecer imunidade, combater infecções, reduzir inflamação sistêmica e acelerar recuperação. Localizado entre o polegar e indicador, na parte carnosa da mão (veja a marcação em destaque na imagem). Pressionar firmemente por 2-3 minutos.',
    ...
    position: { x: 30, y: 65 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/image.png',
...

  {
    ...
    position: { x: 45, y: 80 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/st-36-Estomago-imunidade-a.jpg',
  ...
  // ===== PONTOS PREMIUM - ATM (Articulação Temporomandibular) =====
  {
    ...
    position: { x: 75, y: 30 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/TA-21-Ermen-Portal-da-Orelha-ATM.jpg',
...

  {
    ...
    position: { x: 70, y: 40 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/ATM-Premiun/Ponto-A.jpg',
...

  {
    ...
    position: { x: 85, y: 35 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/ATM-Premiun/Marcacao-3-pontos-ATM-cranio.jpg',
  ...
  // ===== PONTOS PREMIUM - CRANIOPUNTURA AVANÇADA =====
  {
    ...
    description: 'Zona para melhorar memória de trabalho, aumentar capacidade de aprendizado, fortalecer conexões neurais e otimizar função cognitiva. Localizada na região parietal da cabeça (veja as marcações dos pontos Cérebro e Cerebelo na imagem). Aplicar pressão muito suave com movimentos circulares por 5 minutos.',
...

  {
    ...
    description: 'Zona para aumentar capacidade de foco, melhorar atenção sustentada, reduzir dispersão mental e otimizar função executiva. Localizada na região frontal da cabeça (veja o ponto básico A em destaque na imagem). Pressionar suavemente com movimentos específicos por 4-5 minutos.',
    ...
    position: { x: 50, y: 25 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/Ponto-basico-A-dor-de-cabeca-e-enxaqueca.jpg',
...

  {
    ...
    description: 'Zona para reduzir ansiedade crônica, regular resposta emocional, acalmar sistema nervoso e melhorar estabilidade emocional. Localizada na região temporal da cabeça (veja a marcação do ponto Taiyang em destaque na imagem). Aplicar pressão muito leve com técnica específica por 6-8 minutos.',
    ...
    position: { x: 75, y: 35 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/Taiyang.jpg',
...

  {
    ...
    position: { x: 85, y: 35 },
    image: 'https://peicfjwigfxnhkobpgmw.supabase.co/storage/v1/object/public/acupressure-images/ANmian-sono-tranquilo-pesadelos.jpg',
